...
<body>
        ...
        <nav class="nav container">
            ...
            <div class="nav_menu" id="nav-menu">
                <ul class="nav_list">
                    ...
                    <li class="nav_item">
                        <a href="contact.php" class="nav_link  active-link">LIÊN HỆ</a>
                    </li>
    ...
    <main class="main">
        ...
        <section class="questions section container">
            ...
            <h3 class="breadcrumb_subtitle">Trang chủ > <span>Liên hệ</span></h3>
            ...
            <div class="contact_container grid">
                ...
                <div>
                    <div class="contact_information">
                        ...
                        <div>
                            <h3 class="contact_title">Gọi cho tôi</h3>
                            <span class="contact_subtitle">0346836728 </span>
                        </div>
                    ...
                    <div class="contact_information">
                        ...
                        <div>
                            ...
                            <span class="contact_subtitle">
                                2251120175@ut.edu.vn  hoặc<br>
                                2251120141@ut.edu.vn
                            </span>
                        </div>
                    ...
                    <div class="contact_information">
                        ...
                        <div>
                            <h3 class="contact_title">Địa chỉ</h3>
                            <span class="contact_subtitle">70 Tô Ký, Tân Chánh Hiệp, Quận 12, TPHCM</span>
                        </div>
                ...
                <form action="" class="contact_form grid">
                    <div class="contact_inputs grid">
                        <div class="contact_content">
                            <label for="" class="contact_label">Tên</label>
                    ...
                    <div class="contact_content">
                        <label for="name" class="contact_label">Chủ đề</label>
                        <input type="text" id="name" class="contact_input">
                    </div>

                    <div class="contact_content">
                        <label for="" class="contact_label">Nội dung tin nhắn</label>
                        <textarea name="" id="" cols="0" rows="7" class="contact_input"></textarea>
                    </div>
                    <div>
                        <a href="#" class="button">Gửi tin nhắn</a>
                    </div>
