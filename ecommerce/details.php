...
<body>
    ...
    <main class="main">
        ...
        <section class="details section container">
            <h2 class="breadcrumb_title">Chi tiet Page</h2>
            <h3 class="breadcrumb_subtitle">Home > <span>Chi tiet san pham</span></h3>

            <div class="details_container grid" id="product-details">
            </div>
        </section>
    </main>
