...
<body>
    ...
    <main class="main">
        ...
        <section class="shop section container">
            ...
            <h3 class="breadcrumb_subtitle">Trang chủ > <span>Cửa hàng</span> > <span>Thức ăn</span></h3>
            ...
            <div class="shop_container grid">
                ...
                <div class="shop_items grid">
                    ...
                    $query = "SELECT * FROM products WHERE category = 'thức ăn cho mèo'"; // Giả sử bạn có cột 'category' trong bảng products
